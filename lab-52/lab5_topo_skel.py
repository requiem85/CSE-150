...
class MyTopology(Topo):
  def __init__(self):
    Topo.__init__(self)
    CoreSwitch = self.addSwitch('s_core')
    Floor1Switch = self.addSwitch('s_floor1')
    Floor2Switch = self.addSwitch('s_floor2')
    TrustedSwitch = self.addSwitch('s_trusted')
    DataCenterSwitch = self.addSwitch('s_data_center')
    
    self.addLink(Floor1Switch, CoreSwitch, port1=1, port2=1)
    self.addLink(Floor2Switch, CoreSwitch, port1=2, port2=2)
    self.addLink(TrustedSwitch, CoreSwitch, port1=3, port2=3)
    self.addLink(DataCenterSwitch, CoreSwitch, port1=4, port2=4)
    
    # Floor 1 Hosts
    h101 = self.addHost('h101', ip='128.114.1.101/24', defaultRoute="h101-eth0", mac='00:00:00:00:00:01')
    self.addLink(h101, Floor1Switch, port1=11, port2=41)
    h102 = self.addHost('h102', ip='128.114.1.102/24', defaultRoute="h102-eth0", mac='00:00:00:00:00:02')
    self.addLink(h102, Floor1Switch, port1=12, port2=42)
    h103 = self.addHost('h103', ip='128.114.1.103/24', defaultRoute="h103-eth0", mac='00:00:00:00:00:03')
    self.addLink(h103, Floor1Switch, port1=13, port2=43)
    h104 = self.addHost('h104', ip='128.114.1.104/24', defaultRoute="h104-eth0", mac='00:00:00:00:00:04')
    self.addLink(h104, Floor1Switch, port1=14, port2=44)

    # Floor 2 Hosts
    h201 = self.addHost('h201', ip='128.114.2.201/24', defaultRoute="h201-eth0", mac='00:00:00:00:00:05')
    self.addLink(h201, Floor2Switch, port1=21, port2=51)
    h202 = self.addHost('h202', ip='128.114.2.202/24', defaultRoute="h202-eth0", mac='00:00:00:00:00:06')
    self.addLink(h202, Floor2Switch, port1=22, port2=52)
    h203 = self.addHost('h203', ip='128.114.2.203/24', defaultRoute="h203-eth0", mac='00:00:00:00:00:07')
    self.addLink(h203, Floor2Switch, port1=23, port2=53)
    h204 = self.addHost('h204', ip='128.114.2.204/24', defaultRoute="h204-eth0", mac='00:00:00:00:00:08')
    self.addLink(h204, Floor2Switch, port1=24, port2=54)
