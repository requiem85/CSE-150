...
class MyTopology(Topo):
  def __init__(self):
    ...
    facutlyWS = self.addHost('facultyWS', ip='10.0.1.2/24', defaultRoute="", mac='00:00:00:00:00:01')
    printer = self.addHost('printer', ip='10.0.1.3/24', defaultRoute="", mac='00:00:00:00:00:02')
    facultyPC = self.addHost('facultyPC', ip='10.0.1.4/24', defaultRoute="", mac='00:00:00:00:00:03')
    studentPC = self.addHost('studentPC', ip='10.0.2.2/24', defaultRoute="", mac='00:00:00:00:00:04')
    labWS = self.addHost('labWS', ip='10.0.2.3/24', defaultRoute="", mac='00:00:00:00:00:05')
    itWS = self.addHost('itWS', ip='10.0.3.2/24', defaultRoute="", mac='00:00:00:00:00:06')
    itPC = self.addHost('itPC', ip='10.0.3.3/24', defaultRoute="", mac='00:00:00:00:00:07')
    examServer = self.addHost('examServer', ip='10.0.100.2/24', defaultRoute="", mac='00:00:00:00:00:08')
    webServer = self.addHost('webServer', ip='10.0.100.3/24', defaultRoute="", mac='00:00:00:00:00:09')
    dnsServer = self.addHost('dnsServer', ip='10.0.100.4/24', defaultRoute="", mac='00:00:00:00:00:10')
    trustedPC = self.addHost('trustedPC', ip='200.20.203.2/32', defaultRoute="", mac='00:00:00:0011')
    guestPC = self.addHost('guestPC', ip='200.20.198.2/32', defaultRoute="", mac='00:00:00:00:00:12')
